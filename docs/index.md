...
cover: splashes/vince_cayo_at_the_chip.jpg
---
<!-- < default -->
<!-- The tag above means - insert everything in this file into the [body] of the default.hbs template -->
<!-- The big featured header  -->
<header class="main-header" style="background-image: linear-gradient(rgba(0, 0, 0, 0.327),rgba(0, 0, 0, 0.3)), url({{ site.baseurl }}/assets/images/{{ page.cover }}); background-position-y:0">
